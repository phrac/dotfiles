...
enum { WIN_WIDTH = 1024, WIN_HEIGHT = 768 };

/* bar font:
 * (see fonts-conf(5) subsection "FONT NAMES" for valid values)
 */
static const char *const BAR_FONT = "JetBrainsMono Nerd Font:size=9";

/* colors:
 * overwritten by 'background' and 'foreground' X resource properties.
 * (see X(7) section "COLOR NAMES" for valid values)
 */
static const char *const BG_COLOR = "#475163";
static const char *const FG_COLOR = "#81a1c1";
...
static const int thumb_sizes[] = {32, 64, 96, 128, 160, 320, 640};
